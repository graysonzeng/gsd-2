        ...
        tasks: [
          {
            ...
            rollbackHint: "Revert the planning bridge if MCP persistence regresses.",
            acceptance: "The slice plan persists and renders over MCP.",
            verify: "node --test",
            inputs: ["ROADMAP.md"],
        ...
        tasks: [
          {
            ...
            estimate: "15m",
            files: ["src/x.ts"],
            rollbackHint: "Revert src/x.ts if validation fails.",
            acceptance: "The bridge plan is persisted.",
            verify: "",
            inputs: ["ROADMAP.md"],
        ...
        tasks: [
          {
            ...
            rollbackHint: "Revert the seeded task if DB reopen coverage changes.",
            acceptance: "The seeded slice plan exists before the DB is reopened.",
            verify: "node --test",
        ...
        tasks: [
          {
            ...
            rollbackHint: "Revert blocker discovery setup if replan seeding changes.",
            acceptance: "The blocker task seeds data for replanning.",
            verify: "node --test",
          ...
          },
          {
            ...
            rollbackHint: "Restore the original pending task if replanning is canceled.",
            acceptance: "The pending task remains actionable before replanning.",
            verify: "node --test",
            inputs: ["S09-PLAN.md"],
        ...
        tasks: [
          {
            ...
            estimate: "5m",
            files: ["packages/mcp-server/src/workflow-tools.ts"],
            rollbackHint: "Revert canonical task seeding if completion setup changes.",
            acceptance: "The canonical task is ready for slice completion.",
            verify: "node --test",
        ...
        tasks: [
          {
            ...
            estimate: "5m",
            files: ["packages/mcp-server/src/workflow-tools.ts"],
            rollbackHint: "Revert alias task seeding if alias completion setup changes.",
            acceptance: "The alias task is ready for slice completion.",
            verify: "node --test",
        ...
        tasks: [
          {
            ...
            estimate: "10m",
            files: ["packages/mcp-server/src/workflow-tools.ts"],
            rollbackHint: "Revert lifecycle seeding if milestone closure setup changes.",
            acceptance: "The lifecycle task leaves the milestone ready for validation and completion.",
            verify: "node --test",
        ...
        tasks: [
          {
            ...
            estimate: "10m",
            files: ["packages/mcp-server/src/workflow-tools.ts"],
            rollbackHint: "Revert reassessment seed data if roadmap mutation coverage changes.",
            acceptance: "The completed slice is ready for gate save and reassessment flows.",
            verify: "node --test",
