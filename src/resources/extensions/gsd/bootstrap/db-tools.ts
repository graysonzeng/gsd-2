  ...
  const planSliceTool = {
    ...
    parameters: Type.Object({
      ...
      tasks: Type.Array(Type.Object({
        ...
        files: Type.Array(Type.String(), { description: "Files likely touched", minItems: 1 }),
        rollbackHint: Type.String({ description: "Rollback hint for this task" }),
        acceptance: Type.String({ description: "Acceptance criteria for this task" }),
